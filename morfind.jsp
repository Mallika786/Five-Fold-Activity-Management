...
<html>
    <head>
       <script type="text/javascript">
            function insert(){
                document.form1.action="morinsert.jsp"
                document.form1.submit();
            }
            function deleter(){
                document.form1.action="mordelete.jsp"
                document.form1.submit();
            }
            function update(){
                document.form1.action="morupdate.jsp"
                document.form1.submit();
            }
            function find(){
                document.form1.action="morfind.jsp"
                document.form1.submit();
            }
            function display(){
                document.form1.action="morclear.jsp"
                document.form1.submit();
            }
            </script>
    </head>
    <body bgcolor="#90e0ef">
        <% 
           ...
           if(u!=null)
           {
               PreparedStatement ps= new BV.Connect().con.prepareStatement("select * from moral where name = ? ");
               ps.setString(1,u);
        ...
        <h1 style="color:#03045e ">MORAL</h1>
        <img src="mor.jpg" width="1280" height="328" alt="phy"/>
