...
<html>
    <head>
       <script type="text/javascript">
            function insert(){
                document.form1.action="prainsert.jsp"
                document.form1.submit();
            }
            function deleter(){
                document.form1.action="pradelete.jsp"
                document.form1.submit();
            }
            function update(){
                document.form1.action="praupdate.jsp"
                document.form1.submit();
            }
            function find(){
                document.form1.action="prafind.jsp"
                document.form1.submit();
            }
            function display(){
                document.form1.action="praclear.jsp"
                document.form1.submit();
            }
            </script>
    </head>
    <body bgcolor="#90e0ef">
        <% 
           ...
           if(u!=null)
           {
               PreparedStatement ps= new BV.Connect().con.prepareStatement("select * from practical where name = ? ");
               ps.setString(1,u);
