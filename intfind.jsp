...
<html>
    <head>
       <script type="text/javascript">
            ...
            function display(){
                document.form1.action="intclear.jsp"
                document.form1.submit();
            }
            </script>
    </head>
    <body bgcolor="#90e0ef">
        <% 
           ...
           if(u!=null)
           {
               PreparedStatement ps= new BV.Connect().con.prepareStatement("select * from intellectual where name = ? ");
               ps.setString(1,u);
        ...
        <h1 style="color:#03045e ">INTELLECTUAL</h1>
