...
<html>
    <head>
       <script type="text/javascript">
            function insert(){
                document.form1.action="aesinsert.jsp"
                document.form1.submit();
            }
            function deleter(){
                document.form1.action="aesdelete.jsp"
                document.form1.submit();
            }
            function update(){
                document.form1.action="aesupdate.jsp"
                document.form1.submit();
            }
            function find(){
                document.form1.action="aesfind.jsp"
                document.form1.submit();
            }
            
            function display(){
                document.form1.action="aesdisplay.jsp"
                document.form1.submit();
            }
            </script>
    </head>
    ...
    <form name="form1" method="post"><center>
        <h1 style="color:#03045e ">AESTHETIC</h1>
        <img src="aes.jpg" width="1280" height="328" alt="phy"/>
        ...
        <center><table border="1">
         ...
         <%
            ...
            ResultSet rs=stat.executeQuery("Select * from aesthetic");
            while(rs.next()){
                %>
            <tr>
